...
const PAGE_ITEMS: SearchItem[] = [
  ...
  { id: 'activity', title: 'Activity', subtitle: 'Calendar heatmap of session history and streaks', href: '/activity', icon: <Calendar className="w-4 h-4" />, category: 'page', keywords: ['activity', 'heatmap', 'streak', 'calendar', 'history'] },
  ...
  { id: 'changelog', title: 'Changelog', subtitle: 'Release notes and what changed in each version', href: '/changelog', icon: <Sparkles className="w-4 h-4" />, category: 'page', keywords: ['changelog', 'release', 'update', 'whats new', 'version'] },
