          ...
          <div className="mt-8 grid gap-6 md:grid-cols-[1.6fr_1fr]">
            <section className="rounded-2xl border p-5" style={{ borderColor: 'var(--glass-border)', background: 'var(--glass-bg)' }}>
              ...
              <p className="mt-3 text-sm text-text-secondary">
                Activate this key inside Mission Control using <span className="font-medium text-text-primary">{order.email}</span>.
              </p>
            </section>
            ...
            <section className="rounded-2xl border p-5" style={{ borderColor: 'var(--glass-border)', background: 'var(--glass-bg)' }}>
              ...
              <dl className="mt-3 space-y-2 text-sm text-text-secondary">
                <div className="flex justify-between gap-4"><dt>Plan</dt><dd className="text-text-primary">{order.planName}</dd></div>
                <div className="flex justify-between gap-4"><dt>Email</dt><dd className="text-text-primary">{order.email}</dd></div>
                <div className="flex justify-between gap-4"><dt>Status</dt><dd className="text-text-primary">{order.status}</dd></div>
              </dl>
            </section>
          </div>
        )}
